...
\textit{scientific rationale and phased evolution}

The scientific rationale of this project is to rapidly detect high-energy transient events, such as Gamma-ray bursts (GRBs), and provide accurate localisations to inform multi-messenger research endeavours. Transients like GRBs start with a short emission in the high-energy range ($\gamma$-ray/X-ray) and shift to lower energy bands through optical and infrared down to radio waves. Therefore, detecting these fast high-energy flashes would allow us to distribute alerts to other flagship telescopes both space and ground based to observe that location. Additionally, gravitational-wave observatories like Einstein Telescope (ET) or the Laser Inteferometry Space Antenna (LISA) will provide high quality GW detections, however it is difficult to measure the distance to their sources. Electromagnetic (EM) counterparts could be linked to GW events, making it possible to know the source's location and properties more accurately \citep{GW_review}. For physics the observation of transient events and coordination with GW detections is of great interest for astrophysics, fundamental physics, cosmology, gravitational-wave physics and more.
...
CAPIBARA aims to leverage the high-energy detector heritage by past CubeSat missions such as EIRSAT-1, HERMES and BurstCube. Our intention is to implement ... flight-proven detector technology to detect EM radiation in the ... energy range. % we don't have to detail this if we don't know it



\section{Discussion}

CAPIBRA as a platform for student growth and development in all roles/fields

CRD proves we can build, COSMOS invites you to cotribute to MM
