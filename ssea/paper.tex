...
To pursue our goals, we divide them into two aspects: ionic and photonic detections, two distinct messengers that carry substantially different information. To understand the complexity of space, the scientific community requires the integration and correlation of heterogeneous observational data. Indeed, modern astronomy is often described as multimessenger astronomy, and our programmes are framed within this scenario. These goals are addressed through two missions of increasing complexity and ambition.”
...
CAPIBARA Team members are currently taking the first steps into COSMOS in its Phase 0, setting up the mission plan and building up the knowledge needed in involved physics and engineering fields, during this time we will take a look to heritage from other pathfinders student-led missions. By 2027 we plan to start the actual firts phase, charatherised by the launch of two 3-6U CubeSats: Duo-1 and Duo-2. This will be our testing ground to perform time-delay localization and coordinate more than one satellite; with the help of crucial partnerships, such as universities, Spark, OBA Faraday, ESA and we hope in the future even more of them, we are going to build a full efficient network of 6 satellites or more to provide rapid data and even more precise localization.   leverage heritage missions and integrate into a gap for the 2030s
